...
export FZF_DEFAULT_COMMAND="fd --exclude={.git,.idea,.vscode,.sass-cache,node_modules,build,tmp, target} --type f"
...
PATH=/usr/local/texlive/2021/bin/x86_64-linux:$PATH
PATH=~/.local/share/nvim/distant.nvim/bin/:$PATH
...
__conda_setup="$('/home/neeladri/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/neeladri/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/neeladri/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/neeladri/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
